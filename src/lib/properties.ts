...
export const properties: Property[] = [
  {
    ...
    occupancyType: "Single, Double and Triple AC Rooms",
  ...
  },
  {
    ...
    ac: true,
    verified: true,
    availability: "Single and double available",
    occupancyType: "Premium Girls AC Rooms",
  ...
  },
  {
    ...
    ac: true,
    verified: true,
    availability: "Single and triple available",
    occupancyType: "Furnished AC Rooms",
