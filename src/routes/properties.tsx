...
export const Route = createFileRoute("/properties")({
  head: () => ({
    meta: [
      { title: "PG & Coliving Properties in Mumbai — MyRoomiee" },
      { name: "description", content: "Browse verified fully furnished PG, coliving and managed accommodation in Mumbai. Filter by location, budget and sharing." },
      { property: "og:title", content: "Properties — MyRoomiee" },
      { property: "og:description", content: "Browse verified PG and coliving properties across Mumbai." },
    ],
          ...
          <div>
            ...
            <div className="mt-10 rounded-3xl gradient-brand p-8 text-white">
              ...
              <div className="mt-4 flex flex-wrap gap-2">
                ...
                <a href="https://wa.me/919999999999" className="rounded-full border border-white/40 px-4 py-2 text-sm font-semibold">WhatsApp Now</a>
              </div>
            </div>
          </div>
        </div>
