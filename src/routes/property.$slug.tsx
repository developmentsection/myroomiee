...
export const Route = createFileRoute("/property/$slug")({
  ...
  head: ({ loaderData }) => {
    ...
    const description = `${loaderData.occupancyType} in ${loaderData.location}, Mumbai from Rs. ${loaderData.priceFrom.toLocaleString("en-IN")}/month with WiFi, meals, housekeeping, CCTV and zero brokerage.`;
    return {
      meta: [
        { title },
